...
// define a test queues map to add queues to
...
static void test_get_queue_info_success ()
{
    ...
    ok (a.queue_factor == 100,
        "get_queue_info () returns the association priority on success");
}
