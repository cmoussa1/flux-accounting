...
from fluxacct.accounting.database import paths, schema
from fluxacct.accounting.database import info as d
from fluxacct.accounting.database import sql
from fluxacct.accounting.entities import associations as u
from fluxacct.accounting.entities import banks as b
from fluxacct.accounting.entities import projects as p
from fluxacct.accounting.entities import queues as qu
from fluxacct.accounting.jobs import records as j
from fluxacct.accounting.jobs import usage as jobs
from fluxacct.accounting.policy import priorities as prio
from fluxacct.accounting.presentation import visuals as vis
    ...
    def add_queue(self, handle, watcher, msg, arg):
        try:
            val = qu.add_queue(
                ...
                msg.payload.get("max_nodes"),
                msg.payload.get("max_cores"),
            )
