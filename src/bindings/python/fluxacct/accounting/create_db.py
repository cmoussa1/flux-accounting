...
def add_usage_columns_to_table(
    ...
    print(f"priority_usage_reset_period: {priority_usage_reset_period}")
    print(f"priority_decay_half_life: {priority_decay_half_life}")
...
def create_db(
    ...
    conn.execute(
        ...
        f"('priority_usage_reset_period', {priority_usage_reset_period})"
    )
    conn.execute(
        f"INSERT INTO config_table VALUES "
        f"('priority_decay_half_life', {priority_decay_half_life})"
    )
