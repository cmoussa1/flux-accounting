    ...
    conn.execute(
        """
            CREATE TABLE IF NOT EXISTS queue_table (
                ...
                max_sched_nodes           int(11)    DEFAULT 2147483647 NOT NULL ON CONFLICT REPLACE DEFAULT 2147483647,
                max_sched_cores           int(11)    DEFAULT 2147483647 NOT NULL ON CONFLICT REPLACE DEFAULT 2147483647,
                PRIMARY KEY (queue)
            );"""
    )
