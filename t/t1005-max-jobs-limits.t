...
test_expect_success 'create fake_user.json' '
	...
	{
		"data" : [
			{"userid": 5011, "bank": "account3", "def_bank": "account3", "fairshare": 0.45321, "max_jobs": 3, "qos": ""},
			{"userid": 5011, "bank": "account2", "def_bank": "account3", "fairshare": 0.11345, "max_jobs": 2, "qos": ""}
		]
	}
	EOF
'
